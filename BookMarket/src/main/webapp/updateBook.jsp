   ...
   <div class="col-md-7">
    ...
    <div class="mb-3 row">
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-8">
				<textarea name="description" cols="50" rows="2" class="form-control" placeholder="100자 이상 적어주세요"><%=rs.getString("b_description") %></textarea>
			</div>
		</div>
		<div class="mb-3 row">
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-8">
				<input type="radio" name="condiion" value="New">신규도서
				<input type="radio" name="condiion" value="Old">중고도서
				<input type="radio" name="condiion" value="EBook">E-Book
			</div>
		</div>
		<div class="mb-3 row">
